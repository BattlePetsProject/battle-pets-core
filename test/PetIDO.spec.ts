...
describe('PetIdo', function () {
  ...
  it('setEnableBuyNftByPet', async function () {
    let setEnableBuyNftByPetTx = await petIdo.setEnableBuyNftByPet(false)
    ...
    // main 0xc60602cafcffda548d656828479879dbaa229b8f1f117009a045d0757ecd5cc9
  })
  ...
  it('buyNftByPet', async function () {
    ...
    for (let i = 0; i < 199; i++) {
      const tx = await petIdo.buyNftByPet(BigNumber.from(100).mul(BigNumber.from(10).pow(18)), BigNumber.from(1))
    ...
    /**
     ...
     buyNftByPet done
     main airdrop
     buyNftByPet 0x4c752d6ba1022591bd39c87a262ec93f5eadf5a73acd34dbe13b7dff75267ff6
     buyNftByPet done
